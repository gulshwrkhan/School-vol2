        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentEnrollment = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StudentGpa = table.Column<float>(type: "real", nullable: false),
                    StudenAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeachersStudents", x => new { x.StudentID, x.TeacherID });
                    table.ForeignKey(
